            ...
            <form>
                <table id="tabOrder">
                    ...
                    <tr id="item1">
                        ...
                        <td class="item"><a href="detail.html"> <img src="images/cart/item1.jpg" align="left"/>欢乐空间量贩式KTV：欢唱套餐2选1，国家法定节假日需到店另付20元，可升级</a>
                        </td>
                        <td>可购买</td>
                    ...
                    <tr id="item2">
                        <td><input type="checkbox" name="item"/></td>
                        <td class="item"><a href="detail.html"> <img src="images/cart/item2.jpg" align="left"/>途乐时尚主题量贩式KTV：任选1小时欢唱，可升级，提供免费WiFi</a>
                        </td>
                        <td>可购买</td>
                        <td><input type="button" value="-" class="btn btnMinus"/>
                            <input class="txt" type="text" value="1" disabled="disabled"/>
                    ...
                    <tr>
                        <td colspan="7" class="cal">
                            <p style="float:left; padding:0px 26px"><input type="button" class="btn1" value="删除"
                                                                           id="btnDelMul"/></p>
